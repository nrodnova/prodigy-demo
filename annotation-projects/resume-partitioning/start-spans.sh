...
prodigy spans.manual resume-partitioning      blank:en    ../../data/resume-partitioning-dataset.jsonl --label PERSONAL_INFO,SUMMARY,EXPERIENCE,EDUCATION,SKILLS,CERTIFICATIONS,PROJECTS,AWARDS,PUBLICATIONS,LANGUAGES,OTHER
